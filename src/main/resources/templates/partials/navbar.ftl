<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <a href="#" class="btn btn-info my-2 my-sm-0 ml-2 justify-content-end"><img src="img/settings.png"></a>
  <a href="/" class="btn btn-danger my-2 my-sm-0 ml-2 justify-content-end"><img src="img/logout.png"></a>
</nav>